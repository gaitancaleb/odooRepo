odoo.define('dotcreek_gantt.tests', function (require) {
'use strict';

const Domain = require('web.Domain');
var GanttView = require('dotcreek_gantt.GanttView');
var GanttRenderer = require('dotcreek_gantt.GanttRenderer');
var GanttRow = require('dotcreek_gantt.GanttRow');
